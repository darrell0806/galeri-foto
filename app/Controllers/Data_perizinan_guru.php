...
class Data_perizinan_guru extends BaseController
{
    ...
    public function menu_print()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2 || session()->get('level') == 3 || session()->get('level') == 4) {
            ...
            echo view('partial/side_menu');
            echo view('partial/top_menu');
            echo view('data_perizinan/menu_print', $data);
            echo view('partial/footer_datatable');    
        }else {
            return redirect()->to('/');
        }
    ...
    public function export_windows()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2 || session()->get('level') == 3 || session()->get('level') == 4) {
            ...
            $idrombel = $guruData['rombel'];


        // Get data perjalanan berdasarkan filter
            $data['perizinan'] = $model->getDataByFilter($blok, $tahun, $rombel, $semester, $idrombel);
    ...
    public function export_excel()
    {
        if (session()->get('level') == 1 || session()->get('level') == 2 || session()->get('level') == 3 || session()->get('level') == 4) {
            ...
            $perizinan = $model->getDataByFilter($blok, $tahun, $rombel, $semester, $idRombel);

...
<section>
  <div class="row match-height">
    <div class="col-md-6 col-12">
      <div class="card">
       <form action="<?= base_url('data_perizinan/export_windows')?>" method="post">
  ...
  <div class="col-md-6 col-12">
    <div class="card">
     <form action="<?= base_url('data_perizinan/export_excel')?>" method="post">
      <div class="card-header bg-primary">
...
<div class="col-md-6 col-12">
  <div class="card">
   <form action="<?= base_url('data_perizinan/export_pdf')?>" method="post">
    <div class="card-header bg-primary">
